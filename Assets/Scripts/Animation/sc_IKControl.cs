...
public class sc_IKControl : MonoBehaviour
{
    ...
    private void OnAnimatorIK(int layerIndex)
    {
        ...
        { // Only carry out the following code if there is an Animator set.
            ...
            anim.SetIKPositionWeight(AvatarIKGoal.LeftFoot, 0);//anim.GetFloat("IKLeftFootWeight"));
            anim.SetIKRotationWeight(AvatarIKGoal.LeftFoot, 0);//anim.GetFloat("IKLeftFootWeight"));
            anim.SetIKPositionWeight(AvatarIKGoal.RightFoot, 0);//anim.GetFloat("IKRightFootWeight"));
            anim.SetIKRotationWeight(AvatarIKGoal.RightFoot, 0);//anim.GetFloat("IKRightFootWeight"));
